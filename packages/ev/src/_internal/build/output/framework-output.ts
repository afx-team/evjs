...
import { assertAfterBuildDeploymentOutputsAvailable } from "../plugins/deployment-output-reservations.js";
import {
  runBeforeBuildHooks,
  runCleanupTasks,
...
import { createFrameworkHtmlDocument } from "./html/framework-html-document.js";
import { type generateHtml, validateHtmlTemplate } from "./html/html.js";
import { buildHtml } from "./html/html-transform.js";
import {
  type CanonicalClientPageDocument,
  compileServerDocumentShells,
} from "./html/server-document-shell.js";
import {
