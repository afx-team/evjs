...
import type { BundlerAdapter } from "../bundler/contracts.js";
import { GENERATED_IR_DIR } from "../generated-ir/generated-contributions.js";
import { publishFrameworkRevision } from "../operations/analyze-and-materialize.js";
import {
  bindCLIShortcuts,
  type UnbindCLIShortcuts,
} from "../operations/cli-shortcuts.js";
import { collectPluginCliShortcuts } from "../plugins/lifecycle.js";
import { getPageRouteTypesPath } from "../typegen/page-route-types.js";
import { getPluginTypesPath } from "../typegen/plugin-types.js";
import type {
  DevDependencyCollector,
  DevDependencyKind,
  PreparedDevRevision,
} from "./revision.js";
import { prepareDevRevision } from "./revision.js";
import {
  assertNoActiveDevDistLock,
  type DevPortReservation,
  reserveDevPorts,
} from "./runtime.js";
import type { DevSession } from "./session.js";
import { startDevSession } from "./session.js";
import {
