...
middleware uses the global anchor or explicit method composition described in
...
by the selected HTTP method's middleware. Invalid exports prevent server startup.
