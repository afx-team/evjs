  ...
  return (
    <div style={styles.app}>
      <nav style={styles.nav}>
        <Link to="/" style={styles.link} activeProps={{ style: styles.activeLink }}>
          Home
        </Link>
        <Link to="/posts" style={styles.link} activeProps={{ style: styles.activeLink }}>
          Posts
        </Link>
        <Link to="/dashboard" style={styles.link} activeProps={{ style: styles.activeLink }}>
          Dashboard
        </Link>
        <Link to="/search" search={{ q: "" }} style={styles.link} activeProps={{ style: styles.activeLink }}>
          Search
        </Link>
      </nav>
      <Outlet />
