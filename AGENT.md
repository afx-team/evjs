...
8. New client code should import page runtime, navigation, shell runtime, RSC
   helpers, and advanced TanStack/static route helpers from the top-level
   `@evjs/client` entry. Subpath exports are intentionally not part of the
...
| `createPagesApp()` | `@evjs/client` | Internal/framework-managed page route runtime used by generated SPA/MPA entries |
